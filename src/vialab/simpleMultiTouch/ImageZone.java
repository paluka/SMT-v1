...
public class ImageZone extends RectZone {
	...
	public void drawZone(){
		...
		if(imageArray && imgIndex >= 0 && imgIndex < imgArray.length){
			...
			if(filter){
				TouchClient.parent.image(filteredImg, x, y, w, h);

			} else {

				TouchClient.parent.image(img2, x, y, w, h);
			}
			...
			if(img != null){
				...
				if(imgRotated){
					...
					TouchClient.parent.translate(this.getX()+this.getWidth(), this.getY()+this.getHeight());
					TouchClient.parent.rotate(imgRotateAmount);
					TouchClient.parent.image(img2, 0, 0, this.getWidth(), this.getHeight());
					...
					TouchClient.parent.image(img2, this.getX(), this.getY(), this.getWidth(), this.getHeight());
				}
			}
